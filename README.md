...
| Paper | Venue | Status |
|:------|:------|:-------|
| **PINCurve-S**: Physics-Informed Neural Curve Stretching for Low-Light Image Enhancement | **IEEE ICIP 2026** | ✅ Accepted |
| **Output Fisher Anchoring (OFA)**: Variance-Weighted Functional Regularization for Continual Object Detection | — | 📝 Under Review |
| Progressive Ensemble YOLOv11 for Riverine Waste Detection with Curriculum Learning | **ACPR 2025**, Springer LNCS | ✅ Accepted |
| **RivPLitter**: A Large-Scale Dataset for Riverine Plastic Litter Detection | **Springer Journal** | 📝 Under Review |
...
### 🔍 [RivPLitter](https://github.com/Anu790j/RivPlitter)
88,860-frame annotated dataset for riverine plastic waste detection. Semi-automated pseudo-labeling pipeline with YOLOv11 — **10× annotation throughput**.
...
### 🌊 [Riverine Detection Pipeline](https://github.com/Anu790j/riverine-plitter)
Progressive ensemble YOLOv11 with curriculum learning — **93.9% mAP@0.5**. Accepted at ACPR 2025.
